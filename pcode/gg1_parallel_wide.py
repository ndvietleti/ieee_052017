...
if __name__ == '__main__':    
    ...
    sizep = []
    sur_size2 = []
    fdate = ["20080318", "20080319", "20080320", "20090330", "20090331", "20090401", "20090402",
             "20100413","20100414", "20100415"]
    ...
    for j in trange(len(fdate), desc="Progress"):
        ...
        for i in range(len(allfile)):
            df = pd.read_csv(allfile[i], header=None, index_col=None, delim_whitespace=True, na_filter=True, usecols=[0, 3], nrows=20000)
            df = df.dropna()
            df.columns = ['t', 's']
     ...
     #   mplt.use('Qt5Agg')
       ...
       # plt.legend(loc="upper left")
        ...
        fig_file = "/home/araik/Dropbox/paper_new/paper_new/fig7_" + str(j+1) + ".eps"
